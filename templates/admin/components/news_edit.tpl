...
<form action="" method="post">
        ...
        <div class="span4">
            ...
            <div>
                <label class="checkbox"><input type="checkbox"
                                               name="display_content" {$news_display_check}> {$lang::admin_component_news_edit_page_display_ckechbox}
                </label>
                <label class="checkbox"><input type="checkbox"
                                               name="important_content" {$news_important_check}> {$lang::admin_component_news_edit_page_important_ckechbox}
                </label>
                {$notify_message}
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="span4">
            ...
            <input type="text" id="keywords" name="keywords" class="input-block-level" value="{$news_keywords}"/><input
                    class="btn btn-info pull-right" type="button"
                    value="{$lang::admin_component_news_edit_page_keybutton_gen}" onClick="countKeywords()">
            <span class="help-block">{$lang::admin_component_news_edit_page_keywords_description}</span>
        </div>
    </div>
    <div class="row">
        <div class="span5">
            <label>{$lang::admin_component_news_edit_page_date_text}: <input type="text" name="date" id="datefield"
                                                                             value="{$news_date}"/>
                <input type="checkbox" id="setcurrentdate"
                       name="current_date"/> {$lang::admin_component_news_edit_page_current_date}
                <span class="help-block">{$lang::admin_component_news_edit_page_date_desc}</span></label>
        </div>
        <div class="span4">
            <input type="submit" name="save" value="{$lang::admin_component_news_edit_page_button_save}"
