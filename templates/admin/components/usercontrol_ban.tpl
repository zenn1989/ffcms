...
<form method="post" action="" class="form-horizontal">
    <fieldset>
        ...
        <div class="control-group">
            <div class="controls">
                <input type="submit" name="idorloginblock"
                       value="{$lang::admin_component_usercontrol_ban_regsearch_button}" class="btn btn-success"/>
            </div>
        </div>
    </fieldset>
</form>
...
<form method="post" action="" class="form-horizontal">
    <fieldset>
        ...
        <div class="control-group">
            <div class="controls">
                <input type="submit" name="ipblock" value="{$lang::admin_component_usercontrol_ban_button_red}"
