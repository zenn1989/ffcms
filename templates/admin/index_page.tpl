<div class="container">
	...
	<div class="row">
		...
		<div class="span4">
			...
			<table class="table">
				<tr>
					<td>/uploads</td><td>{$folder_uploads_access}(+rw)</td>
				</tr>
				<tr>
					<td>/language</td><td>{$folder_language_access}(+rw)</td>
				</tr>
				<tr>
					<td>/cache</td><td>{$folder_cache_access}(+rw)</td>
				</tr>
				<tr>
					<td>/config.php</td><td>{$file_config_access}(+rw)</td>
				</tr>
			</table>
		...
		<div class="span4">
			...
			<table class="table">
				<tr>
					<td>{$lang::admin_block_info_officialsite}</td><td><a href="http://ffcms.ru">www.ffcms.ru</a></td>
				</tr>
				<tr>
					<td>GitHub</td><td><a href="https://github.com/zenn1989/ffcms/">ffcms</a></td>
				</tr>
				<tr>
					<td>{$lang::admin_block_info_revision}</td><td>0.1</td>
				</tr>
		    </table>
		</div>
		<!-- /.span4 -->
