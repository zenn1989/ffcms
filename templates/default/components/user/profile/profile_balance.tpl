...
<table class="table table-bordered">
    ...
    <tr{% if log.type == 'balance.add' or log.type == 'balance.wmadd' or log.type == 'balance.ikadd' %} class="alert-success"{% elseif log.type == 'balance.min' %} class="alert-danger"{% endif %}>
        <td>{{ log.id }}</td>
        <td>{% if log.type == 'balance.add' or log.type == 'balance.wmadd' or log.type == 'balance.ikadd' %}{{ language.usercontrol_profile_settings_balance_in }}{% elseif log.type == 'balance.min' %}{{ language.usercontrol_profile_settings_balance_out }}{% else %}?{% endif %}</td>
        <td>{{ log.amount }}</td>
        <td>{{ log.date }}</td>
        <td>{{ log.message }}</td>
    </tr>
    ...
    <div class="modal fade" id="payinterkassa" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>{{ language.usercontrol_profile_settings_balance_iktype_selected_desc }}: {{ local.config.balance_wm_mul }}</p>
