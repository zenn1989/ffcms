...
<form method="post" action="" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-lg-3 control-label">{{ language.usercontrol_profile_settings_label_name_title }}</label>
        ...
        <div class="form-group">
            <label class="col-lg-3 control-label">{{ language.usercontrol_profile_settings_label_phone_title }}</label>
        ...
        <div class="form-group">
            <label class="col-lg-3 control-label">{{ language.usercontrol_profile_settings_label_birthday_title }}</label>
        ...
        <div class="form-group">
            <label class="col-lg-3 control-label">{{ language.usercontrol_profile_settings_label_sex_title }}</label>
        ...
        <div class="form-group">
            <label class="col-lg-3 control-label">{{ language.usercontrol_profile_settings_label_website_title }}</label>
        ...
        <hr/>
        <div class="form-group">
            <label class="col-lg-3 control-label">{{ language.usercontrol_profile_settings_label_oldpwd_title }}</label>
        ...
        <div class="form-group">
            <label class="col-lg-3 control-label">{{ language.usercontrol_profile_settings_label_newpwd_title }}</label>
        ...
        <div class="form-group">
            <label class="col-lg-3 control-label">{{ language.usercontrol_profile_settings_label_renewpwd_title }}</label>
