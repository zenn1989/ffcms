...
<div class="pull-right"><a href="{$url}/news/{$news_full_link}#comment_load"><i class="icon-comment"></i> Комментарии: {$news_comment_count}</a> <a href="{$url}/news/{$news_full_link}">{$lang::news_view_button_more} <i class="icon-share-alt"></i></a></div>
<br />
<hr class="soft" />