...
{$if com.news.have_similar}
<hr />
<div>
    <h3>{$lang::news_view_similar}:</h3>
    <ul>
        {$news_similar_item}
    </ul>
</div>
    ...
    <div class="tab-pane active" id="comment_site">
        ...
        <div id="loader_comment">
            <div id="comment_load">
                <table class="table">
                    <tr>
                        <td style="text-align: center;" class="alert alert-success"><a href="#comment_load" id="doLoadComment">{$lang::comments_text_loadmore}</a></td>
