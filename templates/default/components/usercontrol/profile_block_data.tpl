				...
				<div class="tab-pane active">
					...
					<div class="span4">
						...
						<form action="{$url}/user/id{$target_user_id}" method="post">
							<textarea style="width: 100%;" name="wall_text" placeHolder="{$lang::usercontrol_profile_pers_form_write}"></textarea>
							<input type="submit" name="wall_post" value="{$lang::global_send_button}" class="btn btn-success pull-right" />
						</form>
						<br />
						{$/if}
						<div>
