	...
	<div class="span1">
		<div class="tabbable tabs-right">
              ...
              {$if com.usercontrol.self_profile && !com.usercontrol.profile_friend_request}
                <li class="active"><a href="{$url}/user/id{$target_user_id}/friends">{$lang::usercontrol_profile_friends}</a></li>
                <li><a href="{$url}/user/id{$target_user_id}/friends/request">{$lang::usercontrol_profile_requests_friends}</a></li>
              {$/if}
              {$if com.usercontrol.self_profile && com.usercontrol.profile_friend_request}
                <li><a href="{$url}/user/id{$target_user_id}/friends">{$lang::usercontrol_profile_friends}</a></li>
                <li class="active"><a href="{$url}/user/id{$target_user_id}/friends/request">{$lang::usercontrol_profile_requests_friends}</a></li>
              {$/if}
              </ul>
        </div>
	</div>
