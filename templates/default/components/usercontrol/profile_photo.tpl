...
<ul class="nav nav-tabs nav-stacked">
    ...
    <li class="active"><a href="{$url}/settings/avatar"
                          data-toggle="modal">{$lang::usercontrol_profile_mymenu_avachange}</a></li>
    {$/if}
    {$if user.auth && com.usercontrol.self_profile && !com.usercontrol.menu_avatar}
    ...
    <li><a onclick="document.getElementById('friendget').submit();">{$lang::usercontrol_profile_mymenu_addfriend}</a>
    </li>
    {$/if}
    {$if user.auth && !com.usercontrol.self_profile && !com.usercontrol.in_friends && com.usercontrol.in_friends_request}
