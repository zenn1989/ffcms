		...
		imgLoadModal: function() {
			...
			if (this.options.imgupload===true) {
				...
				this.$modal.find("#fupform").bind("submit",$.proxy(function(e) {
					$(e.target).parents("#imguploader").hide().after('<div class="loader"><span>'+CURLANG.loading+'</span></div>').parent().css("text-align","center");
				},this))
		...
		init: function() {
			if (window.FormData != null) {
				...
				this.$block[0].ondrop = $.proxy(function(e) {
					...
					this.$loader = $('<div class="loader"><span>'+CURLANG.loading+'</span></div>');
