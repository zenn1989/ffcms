...
typeof WBBLANG == "undefined" && (WBBLANG = {}), WBBLANG.ru = CURLANG = {bold: "Полужирный", italic: "Курсив", underline: "Подчеркнутый", strike: "Зачеркнутый", link: "Ссылка", img: "Изображение", sup: "Надстрочный текст", sub: "Подстрочный текст", justifyleft: "Текст по левому краю", justifycenter: "Текст по центру", justifyright: "Текст по правому краю", table: "Вставить таблицу", bullist: "Обычный список", numlist: "Нумерованный список", quote: "Цитата", offtop: "Оффтоп", code: "Код", spoiler: "Сворачиваемый текст", fontcolor: "Цвет текста", fontsize: "Размер текста", fontfamily: "Шрифт текста", fs_verysmall: "Очень маленький", fs_small: "Маленький", fs_normal: "Нормальный", fs_big: "Большой", fs_verybig: "Очень большой", smilebox: "Вставить смайл", video: "Вставить видео", removeFormat: "Удалить форматирование", modal_link_title: "Вставить ссылку", modal_link_text: "Отображаемый текст", modal_link_url: "URL ссылки", modal_email_text: "Отображаемый эл.адрес", modal_email_url: "Email", modal_link_tab1: "Вставить URL", modal_img_title: "Вставить изображение", modal_img_tab1: "Ввести URL", modal_img_tab2: "Загрузить файл", modal_imgsrc_text: "Введите адрес изображения", modal_img_btn: "Выберите файл для загрузки", add_attach: "Добавить вложение", modal_video_text: "Введите URL видео", close: "Закрыть", save: "Сохранить", cancel: "Отмена", remove: "Удалить", validation_err: "Введенные данные некорректны", error_onupload: "Ошибка во время загрузки файла или такое расширение файла не поддерживается", fileupload_text1: "Перетащите файл сюда", fileupload_text2: "или", loading: "Загрузка", auto: "Авто", views: "Просмотров", downloads: "Скачиваний", sm1: "Улыбка", sm2: "Смех", sm3: "Подмигивание", sm4: "Спасибо, класс", sm5: "Ругаю", sm6: "Шок", sm7: "Злой", sm8: "Огорчение", sm9: "Тошнит"}, wbbdebug = !0, function (e) {
    ...
    e.wysibb = function (t, n) {
        ...
        this.options = {bbmode: !1, onlyBBmode: !1, themeName: "default", bodyClass: "", lang: "ru", tabInsert: !0, imgupload: !0, img_uploadurl: "/iupload.php", img_maxwidth: 800, img_maxheight: 800, hotkeys: !0, showHotkeys: !0, autoresize: !0, resize_maxheight: 800, loadPageStyles: !0, traceTextarea: !0, smileConversion: !0, buttons: "bold,italic,underline,strike,sup,sub,|,img,video,link,|,bullist,numlist,smilebox,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,quote,code,offtop,table,removeFormat", allButtons: {bold: {title: CURLANG.bold, buttonHTML: '<span class="fonticon ve-tlb-bold1"></span>', excmd: "bold", hotkey: "ctrl+b", transform: {"<b>{SELTEXT}</b>": "[b]{SELTEXT}[/b]", "<strong>{SELTEXT}</strong>": "[b]{SELTEXT}[/b]"}}, italic: {title: CURLANG.italic, buttonHTML: '<span class="fonticon ve-tlb-italic1"></span>', excmd: "italic", hotkey: "ctrl+i", transform: {"<i>{SELTEXT}</i>": "[i]{SELTEXT}[/i]", "<em>{SELTEXT}</em>": "[i]{SELTEXT}[/i]"}}, underline: {title: CURLANG.underline, buttonHTML: '<span class="fonticon ve-tlb-underline1"></span>', excmd: "underline", hotkey: "ctrl+u", transform: {"<u>{SELTEXT}</u>": "[u]{SELTEXT}[/u]"}}, strike: {title: CURLANG.strike, buttonHTML: '<span class="fonticon fi-stroke1 ve-tlb-strike1"></span>', excmd: "strikeThrough", transform: {"<strike>{SELTEXT}</strike>": "[s]{SELTEXT}[/s]", "<s>{SELTEXT}</s>": "[s]{SELTEXT}[/s]"}}, sup: {title: CURLANG.sup, buttonHTML: '<span class="fonticon ve-tlb-sup1"></span>', excmd: "superscript", transform: {"<sup>{SELTEXT}</sup>": "[sup]{SELTEXT}[/sup]"}}, sub: {title: CURLANG.sub, buttonHTML: '<span class="fonticon ve-tlb-sub1"></span>', excmd: "subscript", transform: {"<sub>{SELTEXT}</sub>": "[sub]{SELTEXT}[/sub]"}}, link: {title: CURLANG.link, buttonHTML: '<span class="fonticon ve-tlb-link1"></span>', hotkey: "ctrl+shift+2", modal: {title: CURLANG.modal_link_title, width: "500px", tabs: [
            {input: [
                {param: "SELTEXT", title: CURLANG.modal_link_text, type: "div"},
                {param: "URL", title: CURLANG.modal_link_url, validation: "^http(s)?://"}
            ]}
        ]}, transform: {'<a href="{URL}">{SELTEXT}</a>': "[url={URL}]{SELTEXT}[/url]", '<a href="{URL}">{URL}</a>': "[url]{URL}[/url]"}}, img: {title: CURLANG.img, buttonHTML: '<span class="fonticon ve-tlb-img1"></span>', hotkey: "ctrl+shift+1", modal: {title: CURLANG.modal_img_title, width: "600px", tabs: [
        ...
        ], transform: {'<font face="{FONT}">{SELTEXT}</font>': "[font={FONT}]{SELTEXT}[/font]"}}, smilebox: {type: "smilebox", title: CURLANG.smilebox, buttonHTML: '<span class="fonticon ve-tlb-smilebox1"></span>'}, justifyleft: {title: CURLANG.justifyleft, buttonHTML: '<span class="fonticon ve-tlb-textleft1"></span>', groupkey: "align", transform: {'<p style="text-align:left">{SELTEXT}</p>': "[left]{SELTEXT}[/left]"}}, justifyright: {title: CURLANG.justifyright, buttonHTML: '<span class="fonticon ve-tlb-textright1"></span>', groupkey: "align", transform: {'<p style="text-align:right">{SELTEXT}</p>': "[right]{SELTEXT}[/right]"}}, justifycenter: {title: CURLANG.justifycenter, buttonHTML: '<span class="fonticon ve-tlb-textcenter1"></span>', groupkey: "align", transform: {'<p style="text-align:center">{SELTEXT}</p>': "[center]{SELTEXT}[/center]"}}, video: {title: CURLANG.video, buttonHTML: '<span class="fonticon ve-tlb-video1"></span>', modal: {title: CURLANG.video, width: "600px", tabs: [
            ...
            if (i && i.length == 2) {
                var s = i[1];
                this.insertAtCursor(this.getCodeByCommand(e, {src: s}))
            }
            return this.closeModal(), this.updateUI(), !1
        }}, transform: {'<iframe src="http://www.youtube.com/embed/{SRC}" width="640" height="480" frameborder="0"></iframe>': "[youtube]{SRC}[/youtube]"}}, fs_verysmall: {title: CURLANG.fs_verysmall, buttonText: "fs1", excmd: "fontSize", exvalue: "1", transform: {'<font size="1">{SELTEXT}</font>': "[size=50]{SELTEXT}[/size]"}}, fs_small: {title: CURLANG.fs_small, buttonText: "fs2", excmd: "fontSize", exvalue: "2", transform: {'<font size="2">{SELTEXT}</font>': "[size=85]{SELTEXT}[/size]"}}, fs_normal: {title: CURLANG.fs_normal, buttonText: "fs3", excmd: "fontSize", exvalue: "3", transform: {'<font size="3">{SELTEXT}</font>': "[size=100]{SELTEXT}[/size]"}}, fs_big: {title: CURLANG.fs_big, buttonText: "fs4", excmd: "fontSize", exvalue: "4", transform: {'<font size="4">{SELTEXT}</font>': "[size=150]{SELTEXT}[/size]"}}, fs_verybig: {title: CURLANG.fs_verybig, buttonText: "fs5", excmd: "fontSize", exvalue: "6", transform: {'<font size="6">{SELTEXT}</font>': "[size=200]{SELTEXT}[/size]"}}, removeformat: {title: CURLANG.removeFormat, buttonHTML: '<span class="fonticon ve-tlb-removeformat1"></span>', excmd: "removeFormat"}}, systr: {"<br/>": "\n", '<span class="wbbtab">{SELTEXT}</span>': "   {SELTEXT}"}, customRules: {td: [
            ["[td]{SELTEXT}[/td]", {seltext: {rgx: !1, attr: !1, sel: !1}}]
        ], tr: [
            ["[tr]{SELTEXT}[/tr]", {seltext: {rgx: !1, attr: !1, sel: !1}}]
        ], table: [
            ["[table]{SELTEXT}[/table]", {seltext: {rgx: !1, attr: !1, sel: !1}}]
        ]}, smileList: [
        ...
        ], attrWrap: ["src", "color", "href"]}, this.inited = this.options.onlyBBmode, this.options.themePrefix || e("link").each(e.proxy(function (t, n) {
    ...
    }, e.wysibb.prototype = {lastid: 1, init: function () {
        ...
        for (var r = 0; r < n.length; r++) {
            ...
            if (i.transform && i.skipRules !== !0) {
                ...
                for (var u in o) {
                    var a = u, f = i.transform[u];
                    i.bbSelector || (i.bbSelector = []), e.inArray(f, i.bbSelector) == -1 && i.bbSelector.push(f);
                    if (this.options.onlyBBmode === !1) {
                        u = this.wrapAttrs(u);
                        var l = e(document.createElement("DIV")).append(e(this.elFromString(u, document))), c = this.filterByNode(l.children());
                            ...
                            l.find("*").each(e.proxy(function (t, n) {
                                ...
                                e.each(r, e.proxy(function (t, r) {
                                    ...
                                    if (s)for (var o = 0; o < s.length; o++) {
                                        ...
                                        var a = this.relFilterByNode(n, c), f = i != s[o] ? this.getRegexpReplace(i, s[o]) : !1;
                                        d[u.toLowerCase()] = {sel: a ? e.trim(a) : !1, attr: r, rgx: f}
                                    }
                                }, this));
                                var i = [];
                                e(n).is("iframe") || e(n).contents().filter(function () {
                                    ...
                                    if (o)for (var u = 0; u < o.length; u++) {
                                        ...
                                        var f = this.relFilterByNode(n, c), l = s != o[u] ? this.getRegexpReplace(s, o[u]) : !1, h = f ? e.trim(f) : !1;
                                        if (e.inArray(h, i) > -1 || e(r).parent().contents().size() > 1) {
                                            var p = e("<span>").html("{" + a + "}");
                                            this.setUID(p, "wbb");
                                            var v = s.indexOf(a) + a.length + 1, m = s.substr(v, s.length - v);
                                            r.data = s.substr(0, s.indexOf(a) - 1), e(r).after(this.elFromString(m, document)).after(p), h = (h ? h + " " : "") + this.filterByNode(p), l = !1
                                        }
                                        d[a.toLowerCase()] = {sel: h, attr: !1, rgx: l}, i[i.length] = h
                                    }
                                }, this)), i = null
                            }, this));
                            var v = l.html();
        ...
        this.options.btnlist = n, e.extend(t.rules, this.options.customRules), t.srules = {}, this.options.smileList && e.each(t.smileList, e.proxy(function (n, r) {
            var i = e(this.strf(r.img, t)), s = this.filterByNode(i);
        ...
        if (this.options.onlyBBmode === !1) {
            var t = this.options.minheight || this.$txtArea.outerHeight(), n = this.options.resize_maxheight, r = this.options.autoresize === !0 ? this.options.resize_maxheight : t;
            this.$body = e(this.strf('<div class="wysibb-text-editor" style="max-height:{maxheight}px;min-height:{height}px"></iframe>', {maxheight: r, height: t})).insertAfter(this.$txtArea), this.body = this.$body[0], this.$txtArea.hide(), e.log("WysiBB loaded"), this.$body.addClass("wysibb-body").addClass(this.options.bodyClass), this.options.direction && this.$body.css("direction", this.options.direction);
            ...
            this.txtArea.value.length > 0 && this.txtAreaInitContent(), this.$body.bind("keydown", e.proxy(function (t) {
                if (t.which == 86 && (t.ctrlKey == 1 || t.metaKey == 1) || t.which == 45 && (t.shiftKey == 1 || t.metaKey == 1))return this.$pasteBlock || (this.saveRange(), this.$pasteBlock = e(this.elFromString('<div style="opacity:0;" contenteditable="true">﻿</div>')), this.$pasteBlock.appendTo(this.body), e.support.htmlSerialize || this.$pasteBlock.focus(), setTimeout(e.proxy(function () {
            ...
            }, this)), this.options.traceTextarea === !0 && (e(document).bind("mousedown", e.proxy(this.traceTextareaEvent, this)), this.$txtArea.val("")), this.options.hotkeys === !0 && this.$body.bind("keydown", e.proxy(this.presskey, this)), this.options.smileConversion === !0 && this.$body.bind("keyup", e.proxy(this.smileConversion, this)), this.inited = !0, this.options.autoresize === !0 && (this.$bresize = e(this.elFromString('<div class="bottom-resize-line"></div>')).appendTo(this.$editor).wdrag({scope: this, axisY: !0, height: t}))
        }
        this.$editor.append('<span class="powered">Powered by <a href="http://www.wysibb.com" target="_blank">WysiBB<a/></span>'), this.$txtArea.bind("mouseup keyup", e.proxy(function () {
        ...
        this.options.bbmode == 1 && n.children(".wysibb-toolbar-btn").addClass("on"), this.options.onlyBBmode === !1 && n.children(".wysibb-toolbar-btn").click(e.proxy(function (t) {
        ...
        var i = e('<div class="wysibb-toolbar-btn wbb-dropdown wbb-cp">').appendTo(t).append('<div class="ve-tlb-colorpick"><span class="fonticon"></span><span class="cp-line"></span></div><ins class="fonticon ar"></ins>').append(this.strf('<span class="btn-tooltip">{title}<ins/></span>', {title: r.title})), s = i.find(".cp-line"), o = e('<div class="wbb-list">').appendTo(i);
        o.append('<div class="nc">' + CURLANG.auto + "</div>");
        var u = r.colors ? r.colors.split(",") : [];
        for (var a = 0; a < u.length; a++)u[a] = e.trim(u[a]), u[a] == "-" ? o.append('<span class="pl"></span>') : o.append(this.strf('<div class="sc" style="background:{color}" title="{color}"></div>', {color: u[a]}));
        ...
        var i = e('<div class="wysibb-toolbar-btn wbb-dropdown wbb-tbl">').appendTo(t).append('<span class="btn-inner fonticon ve-tlb-table1"></span><ins class="fonticon ar"></ins>').append(this.strf('<span class="btn-tooltip">{title}<ins/></span>', {title: r.title})), s = e('<div class="wbb-list">').appendTo(i), o = r.rows || 10, u = r.cols || 10, a = o * u;
        s.css("width", u * r.cellwidth + 2 + "px").css("height", o * r.cellwidth + 2 + "px");
        for (var f = 1; f <= u; f++)for (var l = 1; l <= o; l++) {
        ...
        i.find(".tbl-sel").mousedown(e.proxy(function (t) {
            t.preventDefault();
            var n = e(t.currentTarget).attr("title"), r = n.split(","), i = this.options.bbmode ? "[table]" : '<table class="wbb-table" cellspacing="5" cellpadding="0">';
            for (var s = 1; s <= r[0]; s++) {
        ...
        var i = e('<div class="wysibb-toolbar-btn wbb-select wbb-' + n + '">').appendTo(t).append(this.strf('<span class="val">{title}</span><ins class="fonticon sar"></ins>', r)).append(this.strf('<span class="btn-tooltip">{title}<ins/></span>', {title: r.title})), s = e('<div class="wbb-list">').appendTo(i), o = i.find("span.val"), u = e.isArray(r.options) ? r.options : r.options.split(",");
        for (var a = 0; a < u.length; a++) {
            var f = u[a];
            if (typeof f == "string") {
                var l = this.options.allButtons[f];
                l && (l.html ? e("<span>").addClass("option").attr("oid", f).attr("cmdvalue", l.exvalue).appendTo(s).append(this.strf(l.html, {seltext: l.title})) : s.append(this.strf('<span class="option" oid="' + f + '" cmdvalue="' + l.exvalue + '">{title}</span>', l)))
            } else {
                var c = {seltext: f.title};
        ...
        this.controllers.push(i), i.bind("queryState", e.proxy(function (t) {
            o.text(r.title), i.find(".option.selected").removeClass("selected"), i.find(".option").each(e.proxy(function (t, n) {
                var r = e(n), i = this.queryState(r.attr("oid"), !0), s = r.attr("cmdvalue");
            ...
            t.preventDefault();
            var n = e(t.currentTarget).attr("oid"), r = e(t.currentTarget).attr("cmdvalue"), i = this.options.allButtons[n];
            this.execCommand(n, i.exvalue || r || !1), e(t.currentTarget).trigger("queryState")
        }, this))
    }, buildSmilebox: function (t, n, r) {
        if (this.options.smileList && this.options.smileList.length > 0) {
            var i = e(this.strf(r.buttonHTML, r)).addClass("btn-inner"), s = e('<div class="wysibb-toolbar-btn wbb-smilebox wbb-' + n + '">').appendTo(t).append(i).append(this.strf('<span class="btn-tooltip">{title}<ins/></span>', {title: r.title})), o = e('<div class="wbb-list">').appendTo(s);
        ...
        if (r.en !== !0)return!1;
        var i = this.queryState(t, n), s = this.isInClearTextBlock();
        if (s && s != t)return;
        if (r.excmd)if (this.options.bbmode) {
            e.log("Native command in bbmode: " + t);
            if (i && r.subInsert != 1)this.wbbRemoveCallback(t, n); else {
                var o = {};
                r.valueBBname && n && (o[r.valueBBname] = n), this.insertAtCursor(this.getBBCodeByCommand(t, o))
            }
        } else this.execNativeCommand(r.excmd, n || !1); else r.cmd ? r.cmd.call(this, t, n, i) : this.wbbExecCommand.call(this, t, n, i);
        this.updateUI()
    }, queryState: function (t, n) {
        var r = this.options.allButtons[t];
        if (r.en !== !0)return!1;
        if (this.options.bbmode) {
            if (r.bbSelector)for (var i = 0; i < r.bbSelector.length; i++) {
        ...
        if (!r.excmd) {
            if (e.isArray(r.rootSelector))for (var i = 0; i < r.rootSelector.length; i++) {
        ...
        if (i)if (i.modal)e.isFunction(i.modal) ? i.modal.call(this, t, i.modal, r) : this.showModal.call(this, t, i.modal, r); else if (r && i.subInsert != 1)this.wbbRemoveCallback(t); else {
            if (i.groupkey) {
                ...
                if (s) {
                    ...
                    e.each(s, e.proxy(function (t, n) {
                        ...
                        if (r) {
                            var i = e("<span>").html(r.innerHTML), s = this.setUID(i);
        ...
        if (this.options.bbmode) {
            ...
            e.each(r.rootSelector, e.proxy(function (i, s) {
                ...
                if (!u)return!0;
                var a = e(u), f = this.options.rules[s][0][1];
                if (a.is("span[wbb]") || !a.is("span,font")) {
                    if (n === !0)a.remove(); else if (f && f.seltext && f.seltext.sel) {
                ...
                var c = this.getRange(), h = this.getSelectText(), p = this.getSelectNode();
                e.log("selHTML: " + h), h == "" ? h = "﻿" : h = this.clearFromSubInsert(h, t);
                var d = this.elFromString(h), v = window.getSelection ? c.cloneRange() : this.body.createTextRange(), m = window.getSelection ? c.cloneRange() : this.body.createTextRange();
                ...
                var y = this.getSelectText(!1, v), b = this.getSelectText(!1, m);
                if (b != "") {
        ...
        if (t == "insertHTML" && !window.getSelection) {
            ...
            r.pasteHTML(n);
            var i = e("<div>").html(n).text(), s = i.indexOf("﻿");
            s > -1 && (r.moveStart("character", -1 * (i.length - s)), r.select()), this.lastRange = !1
        } else if (t == "insertHTML") {
            var o = this.getSelection(), u = this.elFromString(n), a = this.lastRange ? this.lastRange : this.getRange();
        ...
        if (this.options.bbmode && typeof n == "undefined" || n === !0) {
            var r = t.replace(/.*(\[\/\S+?\])$/, "$1"), i = this.getCursorPosBB() + (t.indexOf(r) != -1 && t.match(/\[.*\]/) ? t.indexOf(r) : t.length);
            if (document.selection)this.txtArea.focus(), this.getSelection().text = t; else if (this.txtArea.selectionStart || this.txtArea.selectionStart == "0")this.txtArea.value = this.txtArea.value.substring(0, this.txtArea.selectionStart) + t + this.txtArea.value.substring(this.txtArea.selectionEnd, this.txtArea.value.length);
        ...
        var e = 0;
        if ("selectionStart"in this.txtArea)e = this.txtArea.selectionStart; else {
            this.txtArea.focus();
            var t = this.getRange(), n = document.body.createTextRange();
            n.moveToElementText(this.txtArea), n.setEndPoint("EndToStart", t), e = n.text.length
        }
        return e
    }, setCursorPosBB: function (e) {
        if (this.options.bbmode)if (window.getSelection)this.txtArea.selectionStart = e, this.txtArea.selectionEnd = e; else {
        ...
        if (e)if (!window.getSelection)e.select(); else {
        ...
        var n = e(t), r = n.get(0).tagName.toLowerCase(), i = r, s = this.getAttributeList(n.get(0));
        e.each(s, e.proxy(function (t, r) {
            var s = n.attr(r);
            r.substr(0, 1) == "_" && (r = r.substr(1, r.length));
            if (s && !s.match(/\{.*?\}/))if (r == "style") {
                var s = n.attr(r), o = s.split(";");
                e.each(o, function (t, n) {
                    n && n.length > 0 && (i += "[" + r + '*="' + e.trim(n) + '"]')
                })
            } else i += "[" + r + '="' + s + '"]'; else if (s && r == "style") {
                var u = s.substr(0, s.indexOf("{"));
                if (u && u != "") {
                    var s = s.substr(0, s.indexOf("{")), o = s.split(";");
                ...
                for (var u = 0; u < this.rsellist.length; u++) {
                    ...
                    if (i && i.is(a)) {
                        ...
                        for (var t = 0; t < f.length; t++) {
                            var l = f[t][0], c = f[t][1], h = !1, p = !1, d = !1;
                            i.is("br") || (l = l.replace(/\n/g, "<br>")), l = l.replace(/\{(.*?)(\[.*?\])*\}/g, e.proxy(function (t, r, s) {
                                ...
                                if (o.attr && h === !1)if (o.attr == "style") {
                                    p = !0;
                                    var m = "", g = o.rgx.replace(/^\.\*\?/, "").replace(/\.\*$/, "").replace(/;$/, "");
        ...
        r || (t = t.replace(/</g, "&lt;").replace(/\{/g, "&#123;").replace(/\}/g, "&#125;")), t = t.replace(/\[code\]([\s\S]*?)\[\/code\]/g, function (e) {
            ...
            if (r != "|" && r != "-") {
                ...
                e.each(this.options.allButtons[r].transform, e.proxy(function (n, r) {
                    ...
                    var s = 0, o;
                    while ((o = (new RegExp(r, "mgi")).exec(t)) != null)if (o) {
                        var u = {};
        ...
        e.each(this.options.smileList, e.proxy(function (t, i) {
            ...
            if (s != -1) {
                var o = r.substring(s + i.bbcode.length, r.length), u = document.createTextNode(o);
        ...
        return n = this.keysToLower(e.extend({}, n)), t.replace(/\{([\w\.]*)\}/g, function (t, r) {
            r = r.toLowerCase();
            var i = r.split("."), s = n[i.shift().toLowerCase()];
        ...
        var t = this.getCursorPosBB(), n = this.prepareRGX(e), r = new RegExp(n, "g"), i, s = 0;
        ...
        if (this.options.smilefind) {
            ...
            t.size() > 0 && (this.options.smileList = [], t.each(e.proxy(function (t, n) {
                var r = e(n);
                this.options.smileList.push({title: r.attr("title"), bbcode: r.attr("alt"), img: r.removeAttr("alt").removeAttr("title")[0].outerHTML})
            }, this)))
        }
    }, destroy: function () {
        ...
        if (t.nodeType == 3) {
            ...
            n.length >= 2 && !this.isInClearTextBlock(t) && e(t).parents("a").size() == 0 && e.each(this.options.srules, e.proxy(function (r, i) {
                var s = i[0], o = n.indexOf(s);
                if (o != -1) {
                    var u = n.substring(o + s.length, n.length), a = document.createTextNode(u), f = document.createElement("SPAN");
        ...
        var i = this.$modal.find(".wbbm-content").html(""), s = this.$modal.find(".wbbm").removeClass("hastabs");
        ...
        r ? s.find("#wbbm-remove").show() : s.find("#wbbm-remove").hide(), e.each(n.tabs, e.proxy(function (t, n) {
            ...
            this.$modal.find(".wbbm-inperr").remove(), this.$modal.find(".wbbm-brdred").removeClass("wbbm-brdred"), e.each(this.$modal.find(".tab-cont:visible .inp-text"), e.proxy(function (t, r) {
                var i = e(r).parents(".tab-cont").attr("tid"), u = e(r).attr("name").toLowerCase(), a = "";
        ...
        if (this.options.bbmode) {
            var s = n.match(/\{[\s\S]+?\}/g);
            n = this.prepareRGX(n);
            var o = new RegExp(n, "g"), u = this.txtArea.value;
        ...
        e.log("imgLoadModal"), this.options.imgupload === !0 ? (this.$modal.find("#imguploader").dragfileupload({url: this.strf(this.options.img_uploadurl, this.options), extraParams: {maxwidth: this.options.img_maxwidth, maxheight: this.options.img_maxheight}, themePrefix: this.options.themePrefix, themeName: this.options.themeName, success: e.proxy(function (e) {
            this.$txtArea.insertImage(e.image_link, e.thumb_link), this.closeModal(), this.updateUI()
        }, this)}), e.support.htmlSerialize || (e.log("IE not posting form by security reason, show default file upload"), this.$modal.find("#nicebtn").hide(), this.$modal.find("#fileupl").css("opacity", 1)), this.$modal.find("#fileupl").bind("change", function () {
            e("#fupform").submit()
        ...
        var n = {x: 0, y: 0, height: 0}, r;
        t.scope.drag_mousedown = function (i) {
            i.preventDefault(), n = {x: i.pageX, y: i.pageY, height: t.height, sheight: t.scope.$body.height()}, r = !0, e(document).bind("mousemove", e.proxy(t.scope.drag_mousemove, this)), e(this).addClass("drag")
        ...
        var n = this.data("wbb"), r = t ? n.getCodeByCommand("link", {url: e, seltext: n.getCodeByCommand("img", {src: t})}) : n.getCodeByCommand("img", {src: e});
    ...
    "use strict";
    function t(t, n) {
        this.$block = e(t), this.opt = e.extend({url: !1, success: !1, extraParams: !1, fileParam: "img", validation: ".(jpg|png|gif|jpeg)$", t1: CURLANG.fileupload_text1, t2: CURLANG.fileupload_text2}, n)
    }
        ...
        if (window.FormData != null) {
            ...
            n.upload && n.upload.addEventListener("progress", t, !1), this.$block[0].ondrop = e.proxy(function (t) {
                ...
                i.append(this.opt.fileParam, r), this.opt.extraParams && e.each(this.opt.extraParams, function (e, t) {
                    i.append(e, t)
                }), this.$loader = e('<div class="loader"><img src="' + this.opt.themePrefix + "/" + this.opt.themeName + '/img/loader.gif" /><br/><span>' + CURLANG.loading + "</span></div>"), this.$block.html(this.$loader), e.ajax({type: "POST", url: this.opt.url, data: i, processData: !1, contentType: !1, xhr: function () {
                    return n
                }, dataType: "json", success: e.proxy(function (e) {
                    e && e.status == 1 ? this.opt.success(e) : this.error(e.msg || CURLANG.error_onupload)
                }, this), error: e.proxy(function (e, t, n) {
